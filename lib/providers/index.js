...
const KiloProvider = require('./kilo-provider');
const RooProvider = require('./roo-provider');
...
function createProvider(toolName, projectRoot, templatesDir, options = {}) {
  switch (toolName) {
    ...
    case 'kilo':
      return new KiloProvider(projectRoot, templatesDir, options);
    case 'roo':
      return new RooProvider(projectRoot, templatesDir, options);
    default:
